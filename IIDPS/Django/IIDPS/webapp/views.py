...
def userlogoutdef(request):
    ...
    # Html & Css Code:
                ...
                <table style="width: 100%;
                    ...
                    <tr>
                        ...
                        <td style="padding: 12px;
                                border: 1px solid #ddd;">{html.escape(d[0])}</td>
                    </tr>
                    <tr>
                        <th style="background-color: #f2f2f2;
                                color: #555;
                        ...
                        <td style="padding: 12px;
                                border: 1px solid #ddd;">{html.escape(d[1])}</td>
                    </tr>
                    <tr>
                        <th style="background-color: #f2f2f2;
                                color: #555;
        ...
        sender_password = "Google App Password"  # App password
...
def fileupload(request):
    if request.method == 'POST':
        ...
        #---------------------------------------------
        dataset = [row.split()[1:100] for row in open('C:\\Paarth\\zah.p50 72 6F 6A 65 63 74\\Final Year Project\\Django\\IIDPS\\MalwareAnalyisis\\malware_analysis_data.csv').readlines()[1:]]
        l=[]
        for l1 in dataset:
	        for l2 in l1:
		        l.append(l2)
...
def filedownload(request):
    if "e_mail" in request.session:
        ...
        filepath = 'C:\\Paarth\\zah.p50 72 6F 6A 65 63 74\\Final Year Project\\Django\\IIDPS\\Data\\'+fname
        print(filepath)
        path = open(filepath)
